...
- MiP-CRIP: `T=10`, `K=200`, `alpha=0.000014996`($\alpha$), `beta=0.001`($\beta$), `lambda_=0.0707`($\lambda$), `step=1.0`($\tau$, ADAM learning rate), `beta1=0.09` (1st moment for ADAM), `beta2=0.999`(2nd moment for ADAM), `eps=1e-8`, `sigma_noise=1e-3`.
